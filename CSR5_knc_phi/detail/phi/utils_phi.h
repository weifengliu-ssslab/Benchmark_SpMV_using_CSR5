...
__attribute__ ((target(mic)))
inline __m512d hscan_phi(__m512d scan512d, __m512d zero512d)
{
    register __m512d t0, t1;

    t0 = _mm512_swizzle_pd(scan512d, _MM_SWIZ_REG_CDAB);
    t1 = _mm512_swizzle_pd(t0, _MM_SWIZ_REG_BADC);
    ...
    t0 = _mm512_swizzle_pd(scan512d, _MM_SWIZ_REG_BADC);
